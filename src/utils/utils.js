...
export const Clamp = {
  ...
  duties: [
    {
      tasks: 'Transform product MVP designs into quality front-end code.',
    },
    {
      tasks:
        ' Develop a customer retention campaign product, using NextJs, Typescript, Redux and TailwindCss for styling and storybook for component stories. ',
    },
    {
      tasks:
        'Collaborate with the Product manager and backend developers to build robust products.',
    },
  ],
}
...
export const curacel = {
  ...
  duties: [
    {
      tasks: 'Build Landing Page for online campaigns and track pages.',
    },
    {
      tasks: ' Increased their online followers to 60% in three months',
    },
    {
      tasks:
        "Create interactive contents that speak the brand's language and convert leads.",
    },
  ],
}
